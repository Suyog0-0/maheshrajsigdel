...
import { FaStethoscope, FaBook, FaHeart, FaChartLine, FaUserFriends, FaCalendarAlt } from "react-icons/fa";
...
const AboutMe = () => {
  ...
  return (
    ...
    <section
      id="about"
      className={`min-h-screen bg-gradient-to-br from-black-900 via-gray-950 to-slate-900 text-slate-200 py-28 px-6 md:px-16 transition-all duration-500 ease-out ${
            ...
            >
              ...
              <div className="relative space-y-8 text-slate-300 leading-relaxed">
                ...
                <div className={`transition-all duration-300 delay-150 ${
                  ...
                  <p className="text-lg">
                    I am a dedicated <span className="text-amber-400 font-medium bg-amber-400/10 px-2 py-1 rounded-md transition-all duration-200 hover:bg-amber-400/20 hover:scale-105 cursor-default">kidney specialist</span> committed to providing compassionate and comprehensive care for patients with kidney-related conditions. My goal is to ensure every individual receives accurate diagnosis, effective treatment, and continuous support throughout their journey toward better health.
                  </p>
                </div>

                {/* Second Paragraph */}
                <div className={`transition-all duration-300 delay-250 ${
                  visibleSections['section-1'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}>
                  <p className="text-lg">
                    With years of clinical experience and a deep interest in <span className="text-orange-400 font-medium bg-orange-400/10 px-2 py-1 rounded-md transition-all duration-200 hover:bg-orange-400/20 hover:scale-105 cursor-default">chronic kidney disease, dialysis management</span>, and <span className="text-orange-400 font-medium bg-orange-400/10 px-2 py-1 rounded-md transition-all duration-200 hover:bg-orange-400/20 hover:scale-105 cursor-default">transplant medicine</span>, I believe in a personalized approach that focuses on both medical excellence and patient well-being.
                  </p>
                </div>

                {/* Third Paragraph */}
                <div className={`transition-all duration-300 delay-350 ${
                  visibleSections['section-1'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}>
                  <p className="text-lg">
                    Beyond my clinical practice, I stay actively involved in <span className="text-red-400 font-medium bg-red-400/10 px-2 py-1 rounded-md transition-all duration-200 hover:bg-red-400/20 hover:scale-105 cursor-default">medical research and patient education</span>, advocating for early detection and prevention of kidney diseases. I am passionate about empowering people to take charge of their kidney health through awareness, lifestyle guidance, and compassionate care.
                  </p>
                </div>

                {/* Fourth Paragraph */}
                <div className={`transition-all duration-300 delay-450 ${
                  visibleSections['section-1'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}>
                  <p className="text-lg">
                    My philosophy of care revolves around trust, respect, and long-term partnership with patients. I believe medicine is not only about treating illnesses but also about guiding people toward <span className="text-amber-400 font-medium bg-amber-400/10 px-2 py-1 rounded-md transition-all duration-200 hover:bg-amber-400/20 hover:scale-105 cursor-default">healthier, more fulfilling lives</span>. My goal is to listen, support, and provide the highest standard of care possible.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-amber-400 mb-3 flex items-center space-x-2">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-cyan-400 mb-3 flex items-center space-x-2">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-red-400 mb-3 flex items-center space-x-2">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-8 relative z-10">
                ...
                {/* ===== VERTICAL DIVIDER ===== */}
                <div className="hidden sm:block h-12 w-px bg-gradient-to-b from-transparent via-white/10 to-transparent"></div>
